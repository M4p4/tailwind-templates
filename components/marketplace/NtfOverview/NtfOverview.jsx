          ...
          <div className="z-10 lg:absolute -mt-2 lg:-mt-0 bg-slate-900 rounded-3xl left-0 w-full lg:max-w-lg lg:top-1/2 lg:transform lg:-translate-y-1/2">
            <div className="p-8 space-y-3">
              ...
              <div className="flex flex-col sm:flex-row border-2 border-emerald-500 rounded-xl p-5 relative items-center">
                <span className="absolute text-gray-400 -top-3 left-7 bg-slate-900 px-2 text-sm">
                  Current Bid
                </span>
                <span className="text-emerald-500 text-3xl mr-3 font-semibold">
                  {price} ETH
                </span>
                <span className="text-gray-400 text-xl">(≈ $13.37)</span>
              </div>

              <div className="space-y-5">
                <div className="flex items-center pt-5">
                  <ClockIcon className="w-8 h-8 mr-2 text-gray-400" />
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0 sm:space-x-3">
                  <div className="bg-sky-600 hover:bg-sky-700 py-3 px-4 w-full rounded-full text-center cursor-pointer">
                    Place a bid
                  </div>
                  <div className="border-slate-600 hover:bg-slate-800 border py-3 px-4 w-full text-center rounded-full cursor-pointer">
                    View Item
                  </div>
                </div>
              </div>
